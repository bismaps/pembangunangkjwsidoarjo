...
<head>
    ...
    <title>Manage Multimedia Donors - Dashboard</title>
    <!-- Bootstrap 5 -->
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="mt-4">
            ...
            <a href="multimedia.php" class="active"><i class="fas fa-desktop"></i> Donatur Multimedia</a>
        </div>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="fas fa-desktop text-info"></i> Manajemen Donatur Multimedia</h2>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="process_donor.php" method="POST" class="d-inline">
                                        <input type="hidden" name="action" value="delete_multimedia">
            ...
            <div class="modal-content">
                <form action="process_donor.php" method="POST">
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah Donatur Multimedia</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <input type="hidden" name="action" value="add_multimedia">
                        <div class="mb-3">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="process_donor.php" method="POST">
                    ...
                    <div class="modal-body">
                        <input type="hidden" name="action" value="edit_multimedia">
